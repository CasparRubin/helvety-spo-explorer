...
export const SettingsContent: React.FC<ISettingsContentProps> = React.memo(
  ({ settings, onSettingsChange }) => {
    ...
    const handleToggleChange = React.useCallback(
      (key: keyof IUserSettings) =>
        (_ev: React.MouseEvent<HTMLElement>, checked?: boolean): void => {
    ...
    return (
      ...
      >
        ...
        >
          <h3
            id="url-display-section-header"
            style={settingsSectionHeaderStyles}
          >
            {UI_MESSAGES.SETTINGS_URL_DISPLAY_SECTION}
          </h3>
          <p
            id="url-display-section-description"
        ...
        >
          ...
          <p
            id="site-info-section-description"
            style={settingsSectionDescriptionStyles}
          >
        ...
        >
          <h3
            id="navigation-section-header"
            style={settingsSectionHeaderStyles}
          >
            {UI_MESSAGES.SETTINGS_NAVIGATION_SECTION}
          </h3>
          <p
            id="navigation-section-description"
            style={settingsSectionDescriptionStyles}
          >
  ...
  (
    prevProps: ISettingsContentProps,
    nextProps: ISettingsContentProps
  ): boolean => {
    /**
